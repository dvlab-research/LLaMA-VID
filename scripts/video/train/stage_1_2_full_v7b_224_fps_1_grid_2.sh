...
deepspeed llamavid/train/train_mem.py \
    ...
    --bf16 True \
    --output_dir ./work_dirs/llama-vid-7b-pretrain-224-video-fps-1-grid-2 \
    --num_train_epochs 1 \
...
deepspeed llamavid/train/train_mem.py \
    ...
    --vision_tower ./model_zoo/LAVIS/eva_vit_g.pth \
    --image_processor ./llamavid/processor/clip-patch14-224 \
    --pretrain_mm_mlp_adapter ./work_dirs/llama-vid-7b-pretrain-224-video-fps-1-grid-2/mm_projector.bin \
    --mm_projector_type mlp2x_gelu \
    --mm_vision_select_layer -2 \
    --mm_use_im_start_end False \
    --mm_use_im_patch_token False \
    ...
    --compress_type "grid:2" \
    --bf16 True \
    --output_dir ./work_dirs/llama-vid-7b-full-224-video-fps-1-grid-2  \
    --num_train_epochs 1 \
